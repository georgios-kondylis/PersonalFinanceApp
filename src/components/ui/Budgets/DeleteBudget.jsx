    ...
    <div className='fixed top-0 left-0 z-50 w-full h-full bg-[#00000090] '>
      <div className='absolute abs_center w-[520px] max-sm:w-[90%] bg-white p-[25px] rounded-[10px] flex flex-col gap-[25px] shadow-sm'>
        ...
        <div className='flex justify-between items-center '>
          <h1 className='txt5'>Delete '{budget.category}'?</h1>
        ...
        <div className='flex flex-col items-center'>
          <button onClick={() => handleDelete(budget._id)} className='red hover:bg-[#c94736ca] w-full rounded-[6px] py-[11px] text-[#fff] font-sans text-[14px] hover:text-[16px] transition1'>
