...
const Withdraw = ({pots, pot, setPotToWithdaw}) => {
          ...
          <div id='NEW_NAME' className='w-full flex flex-col gap-[5px]'>
            ...
            <div className="flex flex-col gap-[10px] items-center justify-between">
                <div id="PROGRESS_BAR" className=" relative overflow-x-hidden w-full rounded-full bg-[#d0d0d0] h-[7.5px]">
                   ...
                   <div id='REMOVE_PROGRESS' className={`${!removedPercent > 0 && 'hidden'} z-50 absolute top-0 bg-RED border-l border-l-[3px] rounded-full ${removedPercent && 'rounded-l-none' } h-full transition-all ease-in-out duration-300`} 
                   style={{
