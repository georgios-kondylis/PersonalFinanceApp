...
const HomePage = ({
  ...
  useEffect(() => {
    if (transactions.length > 0 && budgets.length > 0 && pots.length > 0 && balance.length > 0) {
      setIsLoading(false);
    }
  }, [transactions, budgets, pots, balance]);
      ...
      <div className="flex flex-col headerGAP h-full">
        <div className="flex justify-between items-center">
          ...
          <div className="flex items-center gap-[20px]">
            <h1 className="txt5 max-sm:hidden">
        ...
        <div className="flex flex-wrap gap-4 justify-between">
          {isLoading ? (
            ...
            balance?.map((item, i) => (
              <div
                key={i}
                className={`flex flex-1 min-w-[250px] gap-5 flex-col p-5 rounded-lg
          ...
          <div className="flex flex-col GAP w-[40%] max-1250:w-full">
            ...
            <div className="gridBox max-sm:h-[510px] flex flex-col items-center justify-center max-sm:min-h-[460px] max-sm:justify-between">
              <div className="flex items-center mb-[20px] sm:mb-[40px] justify-between w-full">
                ...
                <div onClick={() => navigate("/budgets")}>
                  <ViewAll label={"See details"} />
                </div>
              </div>
              <div className="flex gap-[10px] max-sm:flex-col w-full justify-center items-center">
            ...
            <div className="gridBox gap-[40px] w-full flex flex-col justify-between">
              <div className="flex items-center justify-between w-full">
                ...
                <div onClick={() => navigate("/recurring-bills")}>
                  <ViewAll label={"See details"} />
                </div>
              </div>
