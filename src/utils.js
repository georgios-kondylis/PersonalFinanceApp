...
export const custom_950px_breakpoint = () => {
...
export const formatCurrency = (amount) => { // Create a currency format function for U.S. dollars (USD)
